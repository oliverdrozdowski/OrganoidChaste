#ifndef FACEINDEXWRITER_HPP_
#define FACEINDEXWRITER_HPP_
...
/**
 * A class written using the visitor pattern for writing face indices to file.
 *
 * The output file is called cellindices.dat by default. If VTK is switched on,
 * then the writer also specifies the VTK output for each cell, which is stored in
 * the VTK cell data "Cell index" by default.
 */
template <unsigned ELEMENT_DIM, unsigned SPACE_DIM>
class FaceIndexWriter : public AbstractFaceWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
