#ifndef BOUNDARYFACEWRITER_HPP_
#define BOUNDARYFACEWRITER_HPP_
...
class BoundaryFaceWriter : public AbstractFaceWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
