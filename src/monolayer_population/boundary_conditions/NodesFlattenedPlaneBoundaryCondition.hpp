#ifndef NODESFLATTENEDPLANEBOUNDARYCONDITION_HPP_
#define NODESFLATTENEDPLANEBOUNDARYCONDITION_HPP_
...
/**
 * A flattened plane boundary condition class, which fixes the movement
 * of nodes to variable planes in the domain.
 * The nodes are constraint to a plane given by a normal vector and
 * the average position along the normal, to allow for global plane movement.
 */
template <unsigned ELEMENT_DIM, unsigned SPACE_DIM = ELEMENT_DIM>
class NodesFlattenedPlaneBoundaryCondition : public AbstractCellPopulationBoundaryCondition<ELEMENT_DIM, SPACE_DIM>
{
private:
    /**
...
public:
     ...
     */
    NodesFlattenedPlaneBoundaryCondition(AbstractCellPopulation<ELEMENT_DIM, SPACE_DIM>* pCellPopulation,
...
{
    /**
     * Serialize information required to construct a NodesFlattenedPlaneBoundaryCondition.
     */
    template <class Archive, unsigned ELEMENT_DIM, unsigned SPACE_DIM>
    inline void save_construct_data(
        Archive& ar, const NodesFlattenedPlaneBoundaryCondition<ELEMENT_DIM, SPACE_DIM>* t, const unsigned int file_version)
    {
    ...
    /**
     * De-serialize constructor parameters and initialize a NodesFlattenedPlaneBoundaryCondition.
     */
    template <class Archive, unsigned ELEMENT_DIM, unsigned SPACE_DIM>
    inline void load_construct_data(
        Archive& ar, NodesFlattenedPlaneBoundaryCondition<ELEMENT_DIM, SPACE_DIM>* t, const unsigned int file_version)
    {
        ...
        ::new (t) NodesFlattenedPlaneBoundaryCondition<ELEMENT_DIM, SPACE_DIM>(p_cell_population, edgeNormal);
    }
} // namespace serialization
} // namespace boost

#endif /*NODESFLATTENEDPLANEBOUNDARYCONDITION_HPP_*/
