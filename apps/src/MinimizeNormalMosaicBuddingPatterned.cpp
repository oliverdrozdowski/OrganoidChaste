    ...
    try
    {
        ...
        */
        ...
        for (unsigned cell_index = 0; cell_index < num_cells; cell_index++)
        {
            ...
            double tension_a = RandomNumberGenerator::Instance()->NormalRandomDeviate(apical_tension, 0.075);
            double tension_b = RandomNumberGenerator::Instance()->NormalRandomDeviate(basal_tension, 0.075);
            double tension_l = RandomNumberGenerator::Instance()->NormalRandomDeviate(lateral_tension, 0.075);
