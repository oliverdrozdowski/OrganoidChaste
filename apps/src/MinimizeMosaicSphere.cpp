...
std::string CreateFilePath(const paramsMosaicSphere& params)
{
    ...
    filepath << "RandomizedMosaicSphere_"
...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        double alpha_avg = 0.76;
        double beta_avg = 0.71;
        ...
        double t1_length = 0.66 / cbrt(3 * 3 * (alpha_avg + beta_avg) / 2.0) / 4.0;
        ...
        std::array<double, 3> wild_type_surface_tensions = { 0.8, 0.75, 0.95 }; // apical, basal, lateral
        std::array<double, 3> mosaic_surface_tensions_1 = { 0.7, 0.65, 0.90 };
        std::array<double, 3> mosaic_surface_tensions_2 = { 0.75, 0.7, 0.95 };
        std::array<double, 3> mosaic_surface_tensions_3 = { 0.7, 0.65, 1.05 };
        std::array<double, 3> mosaic_surface_tensions_4 = { 0.8, 0.75, 1.10 };
        ...
        p_activeT1_modifier->SetActiveT1Rate(10.0);
        ...
        // p_tension_subforce->SetSimulatedAnnealingParameters(0.1, 200.0, 10.0);
