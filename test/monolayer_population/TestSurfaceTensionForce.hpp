...
public:
    void Test2DVertexBasedMonolayerSimulationForVisualizing()
    {
        ...
        FiniteThicknessHoneycombVertexMeshGenerator generator(20, 20, false, t1_length, 0.001, height, area);
        ...
        simulator.SetOutputDirectory("Test3DSurfaceTensionForceBending_active_t1");
        ...
        p_force->CreateSurfaceTensionParametersForCells(1.0, 0.7, 0.7, p_mesh); // apical, basal, lateral
        p_force->SetSimulatedAnnealingParameters(3.0, 190.0, 10.0);
        ...
        p_growth_modifier->SetT1AdaptationDuration(0.03);
        ...
        TS_ASSERT_DELTA(SimulationTime::Instance()->GetTime(), 200.0, 1e-10);
    }
};