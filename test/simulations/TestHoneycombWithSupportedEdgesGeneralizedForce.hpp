...
{
public:
    void Test3DFlatLatticceSupportedEdgeBoundaryConditionGeneralizedForce()
    {
        ...
        unsigned num_cells_x = 5;
        unsigned num_cells_y = 5;
        ...
        cell_population.AddFaceWriter<BoundaryFaceWriter>();

        FiniteThicknessSimulation3d simulator(cell_population);
        simulator.SetOutputDirectory("Test3D_Honeycomb_SupportedEdges_Gen");
        simulator.SetEndTime(0.009);
        ...
        TS_ASSERT_DELTA(SimulationTime::Instance()->GetTime(), 4.0, 1e-10);
    }
};