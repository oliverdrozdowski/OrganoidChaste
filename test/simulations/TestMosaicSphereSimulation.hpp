...
public:
    ...
    {
        unsigned num_cells = 300;
        double height = 2.0 / 3.0 / sqrt(3.0) * cbrt((9.0 / 2.0) * (9.0 / 2.0)) * cbrt(1.1 / 0.4 * 1.1 / 0.4) * 1.0;
        ...
        simulator.SetOutputDirectory("Test3DSphere_mosaic_active_t1_5_random_types");
        ...
        std::array<double, 3> wild_type_surface_tensions = { 1.1, 1.0, 0.6 }; // apical, basal, lateral
        std::array<double, 3> mosaic_surface_tensions_1 = { 1.1, 1.0, 0.7 };
        std::array<double, 3> mosaic_surface_tensions_2 = { 1.1, 1.0, 0.8 };
        std::array<double, 3> mosaic_surface_tensions_3 = { 1.1, 1.0, 0.9 };
        std::array<double, 3> mosaic_surface_tensions_4 = { 1.1, 1.0, 1.0 };
        ...
        p_force->SetSimulatedAnnealingParameters(0.1, 320.0, 10.0);
        p_force->SetSimulationInstance(&simulator);
        p_force->SetPerformActiveT1Swaps();
