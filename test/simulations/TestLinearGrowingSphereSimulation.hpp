...
public:
    void Test3DVertexBasedSphereSimulationForVisualizing()
    {
        ...
        FiniteThicknessRandomizedSphereMeshGenerator generator(num_cells, t1_length, 0.001, height, 3.0 * height, true);
        ...
        simulator.SetOutputDirectory("Test3DSphere_lineargrowth_active_t1_1transitgen_t1rate2");
        ...
        p_force->SetSimulatedAnnealingParameters(0.001, 50.0, 0.0);
        p_force->SetT1TransitionParameters(200.0, false);
