...
public:
    void Test3DVertexBasedSphereSimulationForVisualizing()
    {
        ...
        FiniteThicknessRandomizedSphereMeshGenerator generator(num_cells, t1_length, 0.001, height, radius - height / 2.0);
        ...
        simulator.SetOutputDirectory("Test3DSphere_mosaic_active_t1_5_random_types_3");
        ...
        p_subforce->SetSimulatedAnnealingParameters(0.1, 200.0, 10.0);
        p_subforce->SetSimulationInstance(&simulator);
